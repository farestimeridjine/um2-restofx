 ...
 */
public class HelloEarthRiseMain
    extends Application
{
    ...
    public void start( Stage stage )
    {
        ...
        Group textGroup = GroupBuilder.create().
            layoutX( 50 ).
            layoutY( 180 ).
            children( textRef ).
            clip( RectangleBuilder.create().width( 430 ).height( 85 ).build() ).build();
        ...
        Scene scene = SceneBuilder.create()
            .width( 516 )
            .height( 387 )
            .root( GroupBuilder.create().children( image, textGroup ).build() )
            .build();
